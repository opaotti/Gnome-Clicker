...
namespace BreakInfinity
{
    ...
    public struct @double : IFormattable, IComparable, IComparable<@double>, IEquatable<@double>
    {
        ...
        private @double(double mantissa, long exponent, PrivateConstructorArg _)
        {
            this.mantissa = mantissa;
            this.exponent = exponent;
        }

        public @double(double mantissa, long exponent)
        {
        ...
        public static @double Normalize(double mantissa, long exponent)
        {
        ...
        public static @double FromMantissaExponentNoNormalize(double mantissa, long exponent)
        {
            return new @double(mantissa, exponent, new PrivateConstructorArg());
        }

        public static @double Zero = FromMantissaExponentNoNormalize(0, 0);

        public static @double One = FromMantissaExponentNoNormalize(1, 0);

        public static @double NaN = FromMantissaExponentNoNormalize(double.NaN, long.MinValue);
        ...
        public static @double PositiveInfinity = FromMantissaExponentNoNormalize(double.PositiveInfinity, 0);
        ...
        public static @double NegativeInfinity = FromMantissaExponentNoNormalize(double.NegativeInfinity, 0);
        ...
        public static @double Parse(string value)
        {
            ...
            var result = new @double(double.Parse(value, CultureInfo.InvariantCulture));
            if (IsNaN(result))
            {
        ...
        public static @double Round(@double value)
        {
            ...
            {
                return new @double(Math.Round(value.ToDouble()));
            }
        ...
        public static @double Round(@double value, MidpointRounding mode)
        {
            ...
            if (value.Exponent < MaxSignificantDigits)
            {
                return new @double(Math.Round(value.ToDouble(), mode));
            }
        ...
        public static @double Floor(@double value)
        {
            ...
            if (value.Exponent < MaxSignificantDigits)
            {
                return new @double(Math.Floor(value.ToDouble()));
            }
        ...
        public static @double Ceiling(@double value)
        {
            ...
            if (value.Exponent < MaxSignificantDigits)
            {
                return new @double(Math.Ceiling(value.ToDouble()));
            }
        ...
        public static @double Truncate(@double value)
        {
            ...
            if (value.Exponent < MaxSignificantDigits)
            {
                return new @double(Math.Truncate(value.ToDouble()));
            }
        ...
        public static @double Reciprocate(@double value)
        {
        ...
        private static bool AreSameInfinity(@double first, @double second)
        {
        ...
        public static @double Pow10(double power)
        {
        ...
        public static @double Pow10(long power)
        {
        ...
        public static @double Pow(@double value, long power)
        {
            if (Is10(value))
            {
                return Pow10(power);
        ...
        private static bool Is10(@double value)
        {
            return value.Exponent == 1 && value.Mantissa - 1 < double.Epsilon;
        }

        private static @double PowInternal(@double value, double other)
        {
        ...
        {
            public static string FormatBigDouble(@double value, string format, IFormatProvider formatProvider)
            {
            ...
            private static string FormatGeneral(@double value, int places)
            {
            ...
            private static string FormatExponential(@double value, int places)
            {
                if (value.Exponent <= -ExpLimit || IsZero(value.Mantissa))
                {
    ...
    public static class BigMath
    {
        ...
        /// </summary>
        public static @double RandomBigDouble(double absMaxExponent)
        {
            if (Random.NextDouble() * 20 < 1)
            {
                return @double.Normalize(0, 0);
            }
            ...
            return @double.Normalize(mantissa, exponent);
        }
        ...
        /// </para>
        /// </summary>
        public static @double AffordGeometricSeries(@double resourcesAvailable, @double priceStart,
            @double priceRatio, @double currentOwned)
        {
            var actualStart = priceStart * @double.Pow(priceRatio, currentOwned);

            //return Math.floor(log10(((resourcesAvailable / (priceStart * Math.pow(priceRatio, currentOwned))) * (priceRatio - 1)) + 1) / log10(priceRatio));

            return @double.Floor(@double.Log10(resourcesAvailable / actualStart * (priceRatio - 1) + 1) / @double.Log10(priceRatio));
        }
            ...
            @double currentOwned)
        {
            ...
            return actualStart * (1 - @double.Pow(priceRatio, numItems)) / (1 - priceRatio);
        }
        ...
        /// already own currentOwned), how much of it can you buy?
        /// </summary>
        public static @double AffordArithmeticSeries(@double resourcesAvailable, @double priceStart,
            @double priceAdd, @double currentOwned)
        {
            ...
            var b2 = @double.Pow(b, 2);

            return @double.Floor(
                (@double.Sqrt(b2 + priceAdd * resourcesAvailable * 2) - b) / priceAdd
            );
        }
        ...
        /// </para>
        /// </summary>
        public static @double SumArithmeticSeries(@double numItems, @double priceStart, @double priceAdd,
            @double currentOwned)
        {
            var actualStart = priceStart + currentOwned * priceAdd;
        ...
        /// </para>
        /// </summary>
        public static @double EfficiencyOfPurchase(@double cost, @double currentRpS, @double deltaRpS)
        {
    ...
    public static class BigDoubleExtensions
    {
        ...
        {
            return @double.Ceiling(value);
        }

        public static @double Truncate(this @double value)
        {
            return @double.Truncate(value);
        }

        public static @double Add(this @double value, @double other)
        {
            return @double.Add(value, other);
        }

        public static @double Subtract(this @double value, @double other)
        {
            return @double.Subtract(value, other);
        }

        public static @double Multiply(this @double value, @double other)
        {
            return @double.Multiply(value, other);
        }

        public static @double Divide(this @double value, @double other)
        {
            return @double.Divide(value, other);
        }

        public static @double Reciprocate(this @double value)
        {
            return @double.Reciprocate(value);
        }

        public static @double Max(this @double value, @double other)
        {
            return @double.Max(value, other);
        }

        public static @double Min(this @double value, @double other)
        {
            return @double.Min(value, other);
        }

        public static double AbsLog10(this @double value)
        {
            return @double.AbsLog10(value);
        }
        ...
        {
            return @double.Log2(value);
        }

        public static double Ln(this @double value)
        {
            return @double.Ln(value);
        }
        ...
        {
            return @double.Sinh(value);
        }

        public static @double Cosh(this @double value)
        {
            return @double.Cosh(value);
        }
        ...
        {
            return @double.Asinh(value);
        }

        public static double Acosh(this @double value)
        {
            return @double.Acosh(value);
        }

        public static double Atanh(this @double value)
        {
            return @double.Atanh(value);
        }

        public static @double Pow(this @double value, @double power)
        {
            return @double.Pow(value, power);
        }

        public static @double Pow(this @double value, long power)
        {
            return @double.Pow(value, power);
        }
        ...
        {
            return @double.Cbrt(value);
        }

        public static @double Sqr(this @double value)
        {
            return @double.Pow(value, 2);
        }
